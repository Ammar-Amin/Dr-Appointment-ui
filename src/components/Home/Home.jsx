        ...
        <div className='pb-[100px]'>
            ...
            <div className='min-h-[221px] p-10 background.body bg-[url(https://images.unsplash.com/photo-1531685250784-7569952593d2?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)]'>
                ...
                <div className='my-10 flex gap-4 justify-center'>
                    <DropdownBox
                        rightIcon={<i class="ri-map-pin-line mr-3"></i>}
                        name='Select Location'
                        leftIcon={<i class="ri-arrow-down-s-line ml-3"></i>}
                    />
                    <div className='w-[30%] p-2 bg-white border-[1px] border-slate-300 rounded-lg'>
                        <input
                            type='text'
                            placeholder="eg. Doctor, specialisation, clinic name"
                            className='w-[90%] pl-2 bg-transparent border-none outline-none' />
            ...
            <div className='w-[60%] mx-auto my-4 flex flex-wrap justify-between'>
