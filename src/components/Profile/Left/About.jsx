    ...
    return (
        <div className='w-[590px] mt-[40px] border-[1px] border-slate-300 rounded-xl'>
            ...
            <div className='px-14 py-10'>
                ...
                <div className='mt-10'>
                    <i class="ri-facebook-line p-3 mr-3 text-lg rounded-full border-[1px] border-slate-300 bg-slate-50"></i>
                    <i class="ri-instagram-line p-3 mr-3 text-lg rounded-full border-[1px] border-slate-300 bg-slate-50"></i>
                    <i class="ri-youtube-line p-3 mr-3 text-lg rounded-full border-[1px] border-slate-300 bg-slate-50"></i>
                    <i class="ri-twitter-line p-3 mr-3 text-lg rounded-full border-[1px] border-slate-300 bg-slate-50"></i>
                </div>
            </div>
